                  ...
                  <div className="flex justify-between items-start">
                    ...
                    {label === 'Rata-rata Skor' && (
                      <div className="group/tooltip relative z-20 cursor-help">
                        <AlertCircle className="h-4 w-4 text-slate-300 hover:text-indigo-500 transition-colors" />
                        <div className="absolute right-0 top-full mt-2 hidden w-48 rounded-xl border border-slate-700 bg-slate-800 p-3 text-xs text-white shadow-xl group-hover/tooltip:block">
                  ...
                  <div className="space-y-4">
                    {(() => {
                      ...
                      const varkStyles = [
                        ...
                        { key: 'Auditory', color: 'bg-emerald-500' },
                ...
                <div className="bg-slate-50 px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="group relative flex items-center justify-center">
                      ...
                      <div className="absolute right-0 top-6 hidden w-64 rounded-xl border border-slate-200 bg-white p-3 shadow-xl group-hover:block z-50 text-xs text-slate-600">
                        ...
                        <ul className="list-disc pl-4 mt-1 space-y-0.5 text-[11px]">
                          ...
                          <li>Rata-rata seluruh skor <strong className="text-emerald-600">Tugas Proyek</strong></li>
                        </ul>
                    ...
                    <button 
                      ...
                      className="flex items-center gap-1.5 rounded-lg bg-emerald-50 border border-emerald-200 px-3 py-1.5 text-xs font-semibold text-emerald-700 transition-all hover:bg-emerald-100 disabled:opacity-50 shadow-sm"
                    >
            ...
            <div className="mt-6 rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  { key: 'Auditory', color: 'bg-emerald-50 border-emerald-200', text: 'text-emerald-700' },
