  ...
  return (
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto rounded-[3rem] overflow-hidden relative">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-indigo-100 text-sm font-semibold mb-8">
          ...
          >
            <Link 
              href="/login"
              className="group relative inline-flex items-center gap-3 bg-white text-indigo-900 px-10 py-5 rounded-2xl font-extrabold text-lg transition-all shadow-xl shadow-indigo-900/20 hover:shadow-2xl hover:scale-105"
            >
