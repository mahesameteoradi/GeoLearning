    ...
    <section id="untuk-guru" className="py-24 bg-white border-y border-slate-100 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          className="bg-slate-900 rounded-[2.5rem] overflow-hidden relative shadow-2xl shadow-indigo-900/40 border border-slate-800"
        >
          {/* Decorative shapes */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-500 rounded-full blur-[100px] opacity-20 -translate-y-1/2 translate-x-1/4 mix-blend-overlay" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-emerald-500 rounded-full blur-[100px] opacity-20 translate-y-1/2 -translate-x-1/4 mix-blend-overlay" />
          ...
          <div className="relative p-10 md:p-16 flex flex-col md:flex-row items-center gap-12">
            ...
            >
              <div className="w-32 h-32 bg-slate-800/50 rounded-[2rem] flex items-center justify-center backdrop-blur-md border border-slate-700 shadow-inner">
                <ShieldCheck className="w-16 h-16 text-indigo-400 drop-shadow-md" />
              </div>
            </motion.div>
            <div className="md:w-2/3 text-center md:text-left text-white">
              ...
              >
                <Link 
                  href="/login"
                  className="bg-indigo-600 text-white px-8 py-4 rounded-2xl font-bold transition-all hover:bg-indigo-700 hover:shadow-xl hover:shadow-indigo-900/50 hover:-translate-y-1 border border-indigo-500"
                >
